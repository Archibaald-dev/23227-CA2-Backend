...
//Edit Car component that will edit the clicked on car with passed id
class EditCar extends Component {
    constructor(props) {
        super(props);
        // store the related to the car information into the state
        // these should match the car object from the API
        this.state = {
            name: '', 
            horsepower: '', 
            weels: '', 
        ...
        return (
            <div className="is-fluid">
                ...
                <form onSubmit={this.handleSubmit}>
                    <h2 className="title is-1 has-text-info">Edit Car</h2>
                    <hr />
